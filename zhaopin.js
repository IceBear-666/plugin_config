...
for (var i = 0; i < $('.infoparttimejobs').length; i++) {
    ...
    if ($('input[name=\"filed_203\"]').eq(i).length && $('.infoparttimejobs .mt_endDate').eq(i).html() && $.trim($('input[name=\"filed_203\"]').parent().prev().text()).substring(0, 2) != '职务' && $.trim($('input[name=\"filed_203\"]').parent().prev().text()).substring(0, 2) != '关系') {
        if ($('.infoparttimejobs .mt_endDate').eq(i).html().length < 7) {
...
if ($('h3').eq(5).html() == '英语水平') {
    ...
    for (var k = 0; k < EnglishSkill.length; k++) {
        ...
        } else if ($('.infoOtEnglishSkill .mt_otherSkillEngLevel').eq(k).html() == '雅思' && $('#module_50_filed_239').length) {
    ...
    for (var k = 0; k < EnglishSkills.length; k++) {
        ...
        } else if ($('.infoEnglishSkill .mt_skillEngLevel').eq(k).html() == '大学英语六级' && $('#module_50_filed_219').length) {
...
if ($('h3').eq(4).length&&$('h3').eq(4).html().substring(0, 6) == '英语语言能力') {
    for (var i = 0; i < $('.infoEnglishSkill').length; i++) {
        if ($('select[name=\"filed_225\"]').eq(i).length && $('.infoEnglishSkill .mt_skillEngLevel').eq(i).html()) {
            ...
            } else if ($('.infoEnglishSkill .mt_skillEngLevel').eq(i).html() == '专业四级') {
                $('select[name=\"filed_225\"]').eq(i).prev().find('.selectList div').eq(3).click()
            } else if ($('.infoEnglishSkill .mt_skillEngLevel').eq(i).html() == '大学英语六级') {
                $('select[name=\"filed_225\"]').eq(i).prev().find('.selectList div').eq(2).click()
            } else if ($('.infoEnglishSkill .mt_skillEngLevel').eq(i).html() == '专业八级') {
