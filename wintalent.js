...
if($('#11_100101_1') && $('#mt_height').html()){
	$('#11_100101_1').val($('#mt_height').html());
}
if($('#11_100109_1') && $('#mt_postadd').html()){
	$('#11_100109_1').val($('#mt_postadd').html());
}
if($('#11_100102_1') && $('#mt_weight').html()){
	$('#11_100102_1').val($('#mt_weight').html());
}
if($('#11_100111_1') && $('#mt_jjlxr').html()){
	$('#11_100111_1').val($('#mt_jjlxr').html());
}
if($('#11_100113_1') && $('#mt_jjlxrtel').html()){
	$('#11_100113_1').val($('#mt_jjlxrtel').html());
}
if($('#11_100110_1') && $('#mt_add').html()){
	$('#11_100110_1').val($('#mt_add').html());
}
...
// ---------------通拓科技  -----------------------
if(pathname.indexOf('/wt/TOMTOP/web/index/showNewResume')!=-1){
	if ($('#21_100016_1') && $('#mt_fmphone').html()) {
		$('#21_100016_1').val($('#mt_fmphone').html())
	}
	//实习经历
	for (var i = 0; i < $('.infoparttimejobs').length; i++) {
		if($('#100301_100801_'+(i+1)).length && $('.infoparttimejobs .mt_startDate').eq(i).html()){
		$('#100301_100801_'+(i+1)).val($('.infoparttimejobs .mt_startDate').eq(i).html()); }
		if($('#100301_100802_'+(i+1)).length && $('.infoparttimejobs .mt_endDate').eq(i).html()){
		$('#100301_100802_'+(i+1)).val($('.infoparttimejobs .mt_endDate').eq(i).html()); }
		if($('#100301_100803_'+(i+1)).length && $('.infoparttimejobs .mt_companyName').eq(i).html()){
		$('#100301_100803_'+(i+1)).val($('.infoparttimejobs .mt_companyName').eq(i).html()); }
		if($('#100301_100811_'+(i+1)).length && $('.infoparttimejobs .mt_department').eq(i).html()){
		$('#100301_100811_'+(i+1)).val($('.infoparttimejobs .mt_department').eq(i).html()); }
		if($('#100301_100806_'+(i+1)).length && $('.infoparttimejobs .mt_positionName').eq(i).html()){
		$('#100301_100806_'+(i+1)).val($('.infoparttimejobs .mt_positionName').eq(i).html()); }
		if($('#100301_100810_'+(i+1)).length && $('.infoparttimejobs .mt_workContent .workContent').eq(i).text()){
		$('#100301_100810_'+(i+1)).val($('.infoparttimejobs .mt_workContent .workContent').eq(i).text()); }
		if($('#100301_100807_'+(i+1)).length && $('.infoparttimejobs .mt_companySize').eq(i).html()){
			$('#100301_100807_'+(i+1)).val($('.infoparttimejobs .mt_companySize').eq(i).html());
		}
		if($('#100301_100804_'+(i+1)).length && $('.infoparttimejobs .mt_workcat').eq(i).html()){
			$('#100301_100804_'+(i+1)).get(0).options[3].selected=true;
		}
		if($('#100301_100805_'+(i+1)).length && $('.infoparttimejobs .mt_companyproperty').eq(i).html()){
			var ctype=$('#100301_100805_'+(i+1))[0];
			switch($('.infoparttimejobs .mt_companyproperty').eq(i).html()){
				case '外资-欧美':ctype.options[1].selected=true;break;
				case '外资-非欧美':ctype.options[2].selected=true;break;
				case '合资-欧美':ctype.options[3].selected=true;break;
		...
		var len = $('.infofulltimejobs').length;
		if($('#19_72_'+(i+1+len)).length && $('.infoparttimejobs .mt_startDate').eq(i).html()){
		$('#19_72_'+(i+1+len)).val($('.infoparttimejobs .mt_startDate').eq(i).html()); }
		if($('#19_73_'+(i+1+len)).length && $('.infoparttimejobs .mt_endDate').eq(i).html()){
		$('#19_73_'+(i+1+len)).val($('.infoparttimejobs .mt_endDate').eq(i).html()); }
		if($('#19_198_'+(i+1+len)).length && $('.infoparttimejobs .mt_companyName').eq(i).html()){
		$('#19_198_'+(i+1+len)).val($('.infoparttimejobs .mt_companyName').eq(i).html()); }
		if($('#19_76_'+(i+1+len)).length && $('.infoparttimejobs .mt_positionName').eq(i).html()){
		$('#19_76_'+(i+1+len)).val($('.infoparttimejobs .mt_positionName').eq(i).html()); }
		if($('#19_78_'+(i+1+len)).length && $('.infoparttimejobs .mt_workContent .workContent').eq(i).text()){
		$('#19_78_'+(i+1+len)).val($('.infoparttimejobs .mt_workContent .workContent').eq(i).text()); }
		if($('#100301_100811_'+(i+1+len)).length && $('.infoparttimejobs .mt_department').eq(i).html()){
		$('#100301_100811_'+(i+1+len)).val($('.infoparttimejobs .mt_department').eq(i).html()); }
		if($('#100301_100807_1'+(i+1+len)).length && $('.infoparttimejobs .mt_companySize').eq(i).html()){
			$('#100301_100807_1'+(i+1+len)).val($('.infoparttimejobs .mt_companySize').eq(i).html());
		}
		if($('#100301_100804_'+(i+1+len)).length && $('.infoparttimejobs .mt_workcat').eq(i).html()){
			$('#100301_100804_'+(i+1+len)).get(0).options[3].selected=true;
		}
		if($('#100301_100805_'+(i+1+len)).length && $('.infoparttimejobs .mt_companyproperty').eq(i).html()){
			var ctype=$('#100301_100805_'+(i+1+len))[0];
			switch($('.infoparttimejobs .mt_companyproperty').eq(i).html()){
				case '外资-欧美':ctype.options[1].selected=true;break;
				case '外资-非欧美':ctype.options[2].selected=true;break;
				case '合资-欧美':ctype.options[3].selected=true;break;
...
// ---------------小牛资本  -----------------------
if(pathname.indexOf('/wt/neocapital/web/index/showNewResume')!=-1){
	if ($('#11_247_1') && $('#mt_height').html()) {
		$('#11_247_1').val($('#mt_height').html())
	}
	for (var i = 0; i < $('.infoparttimejobs').length; i++) {
		if($('#979022098_970825508_'+(i+1)) && $('.infoparttimejobs .mt_startDate').eq(i).html()){
		$('#979022098_970825508_'+(i+1)).val($('.infoparttimejobs .mt_startDate').eq(i).html()); }
		if($('#979022098_970825370_'+(i+1)) && $('.infoparttimejobs .mt_endDate').eq(i).html()){
		$('#979022098_970825370_'+(i+1)).val($('.infoparttimejobs .mt_endDate').eq(i).html()); }
		if($('#979022098_970825276_'+(i+1)) && $('.infoparttimejobs .mt_companyName').eq(i).html()){
		$('#979022098_970825276_'+(i+1)).val($('.infoparttimejobs .mt_companyName').eq(i).html()); }
		if($('#979022098_970825165_'+(i+1)) && $('.infoparttimejobs .mt_positionName').eq(i).html()){
		$('#979022098_970825165_'+(i+1)).val($('.infoparttimejobs .mt_positionName').eq(i).html()); }
	}
}	
// ---------------中信银行信用卡中信  -----------------------
if(pathname.indexOf('/wt/Citicbank/web/index')!=-1){
	for(var i=0;i<$('.infoschoolclub').length;i++){
		if($('#1538865239_1538867998_'+(i+1)) && $('.infoschoolclub .mt_positionName').eq(i).html()){
			$('#1538865239_1538867998_'+(i+1)).val($('.infoschoolclub .mt_positionName').eq(i).html());
		}
		if($('#1538865239_1538865841_'+(i+1)) && $('.infoschoolclub .mt_schClubName').eq(i).html()){
			$('#1538865239_1538865841_'+(i+1)).val($('.infoschoolclub .mt_schClubName').eq(i).html());
		}
		if($('#1538865239_1538865731_'+(i+1)) && $('.infoschoolclub .mt_startDate').eq(i).html()){
			$('#1538865239_1538865731_'+(i+1)).val($('.infoschoolclub .mt_startDate').eq(i).html()+'-1');
		}
		if($('#1538865239_1538868235_'+(i+1)) && $('.infoschoolclub .mt_workDes').eq(i).html()){
			$('#1538865239_1538868235_'+(i+1)).val($('.infoschoolclub .mt_workDes').eq(i).html());
		}
	}
}