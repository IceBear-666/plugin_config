(function() {
	...
	function() {
		...
		if ($('input[name=\"RecruitmentPortalPersonProfile_extNormLevel_105656_1152764473\"]') && $('#mt_edu').html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extNormLevel_105656_1152764473\"]').val($('#mt_edu').html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_extNormSchool_105656_1936258228\"]') && $('.infopledu .mt_professional').last().html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extNormSchool_105656_1936258228\"]').val($('.infopledu .mt_professional').last().html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_extOnjjobLevel_105656_782029726\"]') && $('.infopledu .mt_education').last().html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extOnjjobLevel_105656_782029726\"]').val($('.infopledu .mt_education').last().html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_extOnjobSchool_105656_2019869440\"]') && $('.infopledu .mt_professional').last().html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extOnjobSchool_105656_2019869440\"]').val($('.infopledu .mt_professional').last().html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_extaihao_105656_1447697607\"]') && $('#mt_hobbies').html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extaihao_105656_1447697607\"]').val($('#mt_hobbies').html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_exttechang_105656_1065189961\"]') && $('#mt_skill').html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_exttechang_105656_1065189961\"]').val($('#mt_skill').html())
		}
		...
		if ($('textarea[name=\"RecruitmentPortalAdditionalInfo_extziwopingjia_100996_1633314436\"]') && $('#mt_selfIntro').html()) {
			$('textarea[name=\"RecruitmentPortalAdditionalInfo_extziwopingjia_100996_1633314436\"]').val($('#mt_selfIntro').html())
		}
		...
		if ($('input[name=\"RecruitmentPortalPersonProfile_extjiguan_100996_78185789\"]') && $('#mt_nativeplace').html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extjiguan_100996_78185789\"]').val($('#mt_nativeplace').html() + $('#mt_native_city').html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_extxianjudi_100996_1309206790\"]') && $('#mt_livecity_pro').html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extxianjudi_100996_1309206790\"]').val($('#mt_livecity_pro').html() + $('#mt_livecity_city').html())
		}
		if ($('input[name=\"RecruitmentPortalPersonProfile_extjgsf_160149_1949320240\"]') && $('#mt_nativeplace').html()) {
			$('input[name=\"RecruitmentPortalPersonProfile_extjgsf_160149_1949320240\"]').val($('#mt_nativeplace').html())
		}
		...
		if ($('select[name=\"RecruitmentPortalPersonProfile_extzhengzhimianmao_100996_718327857\"]').length && $('#mt_polistatus').html()) {
			var plo = $('select[name=\"RecruitmentPortalPersonProfile_extzhengzhimianmao_100996_718327857\"]')[0];
			switch ($('#mt_polistatus').html()) {
			case '中共党员':
				plo.options[1].selected = true;
				break;
		...
		if ($('#RecruitmentPortalPersonProfile_extyingyushuiping_104852_1858471310').length && $('.infoEnglishSkill .mt_skillEngLevel').last().html()) {
			let ctype = $('#RecruitmentPortalPersonProfile_extyingyushuiping_104852_1858471310')[0];
			...
			$('input[name=\"RecruitmentPortalPersonProfile_extfenshu_104852_850147524\"]').val($('.infoEnglishSkill .mt_skillEngSorce').last().html())
		}
		...
		if ($('#RecruitmentPortalPersonProfile_exteducation_101440_1335004877').length && $('#mt_edu').html()) {
		...
		if ($('#RecruitmentPortalPersonProfile_extzgxl_100996_1192552680').length && $('#mt_edu').html()) {
			let edu = $('#RecruitmentPortalPersonProfile_extzgxl_100996_1192552680')[0];
			switch ($('#mt_edu').html()) {
			case '大学专科':
				edu.options[4].selected = true;
				break;
		...
		if($('textarea[name=\"RecruitmentPortalPersonProfile_extzyjl_105656_36566658\"]') && $('.infoschaward .infopl').length){
			let awardMess = '';
			...
			$('textarea[name=\"RecruitmentPortalPersonProfile_extzyjl_105656_36566658\"]').val(awardMess);
		}
	})
})()