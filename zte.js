...
var personInfo = function(){
	...
	if(_('#drpPolitic').length){
		...
		switch(_v('#mt_polistatus')){
			case '群众':plo[1].selected=true;break;
			case '中共党员':plo[2].selected=true;break;
			case '共青团员':plo[3].selected=true;break;
			case '九三学社':plo[4].selected=true;break;
			case '中国民主同盟':plo[5].selected=true;break;
			case '中国国民党革命委员会':plo[6].selected=true;break;
			case '中国民主建国会':plo[7].selected=true;break;
			case '中国民主促进会':plo[8].selected=true;break;
			case '中国农工民主党':plo[9].selected=true;break;
			case '中国致公党':plo[10].selected=true;break;
			case '台湾民主自治同盟':plo[11].selected=true;break;
			default:plo[12].selected=true;break;
		}
	}
